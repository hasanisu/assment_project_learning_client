...
const Header = () => {
  ...
  const user = {displayName: 'Hasan Imam'}
      ...
      <header className="absolute inset-x-0 top-0 z-50 bg-red-600">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12 text-2xl text-zinc-200">
            <Link
              className="border border-red-600 py-2 px-4 rounded-lg hover:bg-slate-500"
              to="/"
            >
              Home
            </Link>
             ...
             {/* Condition Rendering */}
              {
               ...
               <div className="flex justify-between">
                ...
                <Link to="/login" className="font-semibold leading-4 text-indigo-700 hover:text-sm ease-in duration-75">
                Logout <span aria-hidden="true">&rarr;</span>
              </Link>
              <p className=" text-sm lg:ms-10"> {user.displayName}</p>
               </div>
              :
                ...
                to="/login"
                className="font-semibold leading-4 text-gray-900 hover:text-xl ease-in duration-75"
              >
            ...
            <div className="mt-6 flow-root bg-red-600 rounded-3xl ps-4">
              <div className="-my-6 divide-y divide-gray-500/10 delay-150">
                <div className="space-y-2 py-6">
                  ...
                  <Link t='/blogs' className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    Blogs
                  </Link>
